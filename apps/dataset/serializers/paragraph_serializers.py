...
class ParagraphInstanceSerializer(ApiMixin, serializers.Serializer):
    ...
    def get_request_body_api():
        return openapi.Schema(
            ...
            required=['content'],
            properties={
                'content': openapi.Schema(type=openapi.TYPE_STRING, max_length=99999, title="分段内容",
                                          description="分段内容"),
...
class EditParagraphSerializers(serializers.Serializer):
    ...
    content = serializers.CharField(required=False, max_length=99999, allow_null=True, allow_blank=True,
...
class ParagraphSerializers(ApiMixin, serializers.Serializer):
    title = serializers.CharField(required=False, max_length=256, error_messages=ErrMessage.char(
        "分段标题"), allow_null=True, allow_blank=True)
    content = serializers.CharField(required=True, max_length=99999, error_messages=ErrMessage.char(
        "分段内容"))
