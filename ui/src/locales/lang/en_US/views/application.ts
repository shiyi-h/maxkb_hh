  ...
  applicationForm: {
    ...
    form: {
      ...
      appDescription: {
        ...
        placeholder:
          'Describe the application scenario and use, e.g.: HH assistant answering user questions about HH product usage'
      },
      aiModel: {
        label: 'AI Model',
    ...
    dialogues: {
      ...
      designated_answer:
        'Hello, I am HH Assistant. My knowledge base only contains information related to HH products. Please rephrase your question.'
    }
  },
  prompt: {
    defaultPrompt:
    ...
    defaultPrologue:
      'Hello, I am HH Assistant. You can ask me questions about using HH.\n- What are the main features of HH?\n- Which large language models does HH support?\n- What document types does HH support?'
  }
}
